...
public class DisciplinesInscriptionEvènementsController {
    ...
    public void initialize() {
        ...
        events.add(new String[]{"Saut à la perche"});
        events.add(new String[]{"Course de fond"});
        events.add(new String[]{"Football"});
        events.add(new String[]{"Décathlon"});
        events.add(new String[]{"Saut en longueur"});
        events.add(new String[]{"Volleyball"});
        events.add(new String[]{"Tennis"});
