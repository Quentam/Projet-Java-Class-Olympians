...
public class RésultatsEvDController {

    @FXML
    public Label evDtitile;

    public void setEvDtitle(String eventName) {
        evDtitile.setText(eventName + " - Résultats");
    }
    ...
    private void navigateToPage(String fxmlFile) {
        try {
            ...
            Stage stage = (Stage) evDtitile.getScene().getWindow();
