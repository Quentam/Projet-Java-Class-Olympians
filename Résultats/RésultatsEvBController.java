...
public class RésultatsEvBController {

    @FXML
    public Label evBtitile;

    public void setEvBtitle(String eventName) {
        evBtitile.setText(eventName + " - Résultats");
    }
    ...
    private void navigateToPage(String fxmlFile) {
        try {
            ...
            Stage stage = (Stage) evBtitile.getScene().getWindow();
