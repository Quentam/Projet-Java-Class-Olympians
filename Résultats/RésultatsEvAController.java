...
public class RésultatsEvAController {

    @FXML
    public Label evAtitile;

    public void setEvAtitle(String eventName) {
        evAtitile.setText(eventName + " - Résultats");
    }
    ...
    private void navigateToPage(String fxmlFile) {
        try {
            ...
            Stage stage = (Stage) evAtitile.getScene().getWindow();
